    ...
    return (
        <main className="bg-gray-50">
            <section className={`flex justify-between shadow-sm fixed top-0 left-[15%] right-0 z-10 p-4 transition-all duration-300 ${isScrolled ? 'bg-white backdrop-blur-md bg-opacity-80' : 'bg-transparent'}`}>
                <div>
                    <h3 className="font-semibold text-[24px]">Explore Tasks</h3>
                </div>
                ...
                <div className="w-[100%]">
                    <section className="py-10">
                        <div className="flex justify-between items-center mb-5">
                            <p className="font-semibold text-[20px]">Time Limit</p>
                            <div className="flex gap-3 items-center">
                                <button
                                //  onClick={handlePrevTask} disabled={currentTaskIndex === 0}
                                >
                                    <Image src={Arrowleft} alt="Arrow left" width={10} height={10} />
                                </button>
                                <button
                                // onClick={handleNextTask} disabled={currentTaskIndex + 2 >= tasks.length}
                                >
                    ...
                    <section className="py-10">
                        <div className="flex justify-between items-center mb-5">
                            <p className="font-semibold text-[20px]">New Tasks</p>
                            <div className="flex gap-3 items-center">
                                <button
                                // onClick={handlePrevTask} disabled={currentTaskIndex === 0}
                                >
